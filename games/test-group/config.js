'use strict';
/* ======================================================================
   THE TEST GROUP -- generated by tools/generate.js from example-answers.json
...
const CONFIG = {
  ...
  "host": {
    "name": "JORDAN",
    "quotes": [
      "I MADE A SEATING CHART FOR FOUR PEOPLE.",
      "THE APPETIZERS ARE A SURPRISE. TO ME TOO."
    ]
  },
  "music": {
    "customSongPath": null,
  ...
  "cast": {
    "diner0": {
      ...
      "spriteCol": 1,
      "spriteRow": 7,
      "anecdote": "Brings a board game every time.",
      "quotes": [
        "I BROUGHT THE GAME. NOBODY ASKED.",
        "RULES ARE SUGGESTIONS, MOSTLY."
      ]
    },
    "judge": null,
    "authority": null,
    ...
    "butterfingers": {
      ...
      "quotes": [
        ...
        "THIS IS FOR THE GROUP CHAT LATER."
      ]
    },
    "builder": {
      "name": "RILEY",
      ...
      "spriteRow": 8,
      "quotes": [
        "I ALREADY STARTED BUILDING SOMETHING.",
        "IT WORKS. MOSTLY."
      ]
    }
  },
